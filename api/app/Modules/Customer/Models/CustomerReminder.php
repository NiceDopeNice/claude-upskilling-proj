 ...
 * Upskilling Project
 *
 * @package Modules/Customer/Models/CustomerReminder.php
...
class CustomerReminder extends Model
{
    ...
    protected $fillable = [
        ...
        'send_sms', 'send_email', 'interval_months', 'start_date', 'next_reminder_at',
        'is_active', 'last_sent_at', 'last_send_status',
        'consecutive_failures', 'deactivated_at', 'deactivated_reason', 'created_by',
    ];
